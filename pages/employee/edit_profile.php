      ...
      <div class="col-md-6 profile-container">
        ...
        <form method="POST" enctype="multipart/form-data">
          ...
          <div class="cv-section">
            ...
            <?php if ($current_cv): ?>
            <p>
              <a href="../<?= htmlspecialchars($current_cv); ?>" target="_blank" class="btn cv-view-btn">
                <i class="fas fa-eye me-2"></i> عرض السيرة الذاتية
              </a>
            </p>
            <?php else: ?>
            ...
            <label for="cv_link" class="form-label mt-2">اختر ملف السيرة الذاتية (PDF فقط):</label>
            <input type="file" name="cv_link" id="cv_link" class="form-control" accept="application/pdf">
          </div>
